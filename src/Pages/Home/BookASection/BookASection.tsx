...
const BookASection = () => {
  return (
    <div>
      <div className="hidden md:block bg-[linear-gradient(90deg,_#EAF9FF_0%,_#FFFADF_100%)] px-[122px] pt-[100px]">
      ...
      {/* Mobile Device */}
      <div className="md:hidden bg-[linear-gradient(90deg,_#EAF9FF_0%,_#FFFADF_100%)] px-[122px] pt-[100px]">
        <div className="flex justify-between gap-20 items-center">
          <div>
            <h1 className="text-[36px] font-semibold">
              Let’s build a compassionate world together.
